...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(ISAT.Admin.Test.Web.StructureMapConfig), "Configure")]
	...
	public static class StructureMapConfig
	{
		public static void Configure()
		{
			IoC.Container.Configure(cfg =>
			{
				...
				cfg.AddRegistry(new ActionFilterRegistry(namespacePrefix: "ISAT.Admin.Test.Web"));
